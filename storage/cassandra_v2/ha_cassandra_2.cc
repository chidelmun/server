...
/**
  @file ha_cassandra_v2.cc

  @brief
  The ha_cassandra_v2 engine is a stubbed storage engine for example purposes only;
  it does almost nothing at this point. Its purpose is to provide a source
  code illustration of how to begin writing new storage engines; see also
  storage/example/ha_cassandra_v2.h.
  ...
  @details
  ha_cassandra_v2 will let you create/open/delete tables, but
  nothing further (for example, indexes are not supported nor can data
  be stored in the table). It also provides new status (assandra_v2func_example)
  and system (assandra_v2ulong_var and assandra_v2enum_var) variables.
  ...
  Please read the object definition in ha_cassandra_v2.h before reading the rest
  of this file.
  ...
  @code
  ha_cassandra_v2::store_lock
  ha_cassandra_v2::external_lock
  ha_cassandra_v2::info
  ha_cassandra_v2::rnd_init
  ha_cassandra_v2::extra
  ENUM HA_EXTRA_CACHE        Cache record in HA_rrnd()
  ha_cassandra_v2::rnd_next
  ha_cassandra_v2::rnd_next
  ha_cassandra_v2::rnd_next
  ha_cassandra_v2::rnd_next
  ha_cassandra_v2::rnd_next
  ...
  ha_cassandra_v2::open() would also have been necessary. Calls to
  ha_cassandra_v2::extra() are hints as to what will be occuring to the request.
...
ha_create_table_option cassandra_v2_table_option_list[]=
{
  /*
...
ha_create_table_option cassandra_v2_field_option_list[]=
{
  /*
...
static int cassandra_v2_init_func(void *p)
{
  ...
  cassandra_v2_hton->table_options= cassandra_v2_table_option_list;
  cassandra_v2_hton->field_options= cassandra_v2_field_option_list;
  cassandra_v2_hton->tablefile_extensions= ha_cassandra_v2_exts;
...
ha_cassandra_v2::check_if_supported_inplace_alter(TABLE* altered_table,
                                             Alter_inplace_info* ha_alter_info)
{
  HA_CREATE_INFO *info= ha_alter_info->create_info;
  DBUG_ENTER("ha_cassandra_v2::check_if_supported_inplace_alter");
...
maria_declare_plugin(cassandra_v2)
{
  MYSQL_STORAGE_ENGINE_PLUGIN,
  &cassandra_v2_storage_engine,
  "EXAMPLE",
